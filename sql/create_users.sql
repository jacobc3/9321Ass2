...
INSERT INTO review (user_id,movie_id,rating,post_date,title,content) VALUES (1,4,9,random_datetime(),"Praesent aliquam orci","Praesent aliquam orci at nulla tincidunt pellentesque. Quisque hendrerit sit amet ante sed facilisis. Vestibulum ut nunc aliquet dui cursus commodo vitae ut mauris. Integer elementum sollicitudin metus, et finibus sapien euismod dictum. Donec condimentum quam non nisl lacinia, consectetur faucibus est maximus. Aliquam enim dui, porta at bibendum vitae, suscipit ac nisl. Phasellus ut orci ultricies elit ornare tincidunt. Integer mollis arcu eu tincidunt facilisis. Nullam non odio eu neque ultrices rutrum. Integer gravida est est, sit amet rhoncus lorem convallis sit amet. Suspendisse rhoncus sem velit, in facilisis libero malesuada nec. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Suspendisse dictum dolor lectus, ut consectetur ex placerat eget. Curabitur rutrum eu sapien ut consequat. Cras accumsan turpis ac lectus tincidunt, a elementum nulla scelerisque.
...
INSERT INTO review (user_id,movie_id,rating,post_date,title,content) VALUES (1,5,6,random_datetime(),"Aenean egestas metus ipsum","Aenean egestas metus ipsum, nec volutpat ligula lacinia vitae. Morbi commodo lacus a nulla hendrerit tincidunt");
INSERT INTO review (user_id,movie_id,rating,post_date,title,content) VALUES (2,1,7,random_datetime(),"Cras pulvinar mollis libero","Cras pulvinar mollis libero, eu maximus tortor dictum at. Vestibulum ante ipsum primis");
